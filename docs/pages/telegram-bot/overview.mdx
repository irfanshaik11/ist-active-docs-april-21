...
| Multi-wallet, Arena leaderboards, Airdrop Genesis | No | Yes |
...
- Perps, prediction markets, Arena pages, monitors, wallet tracker, and the full token analytics view. These are web-only.
