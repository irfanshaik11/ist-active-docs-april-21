...
- You need referrals, perps, prediction markets, monitors, wallet tracker, Arena pages — none of these exist in the bot. See [Referrals (web only)](/arena/referrals) and the [product overview](/getting-started/what-is-interstate).
